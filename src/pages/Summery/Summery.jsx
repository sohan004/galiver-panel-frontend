    ...
    return (
        <div>
            ...
            <div className='flex justify-center mt-3'>
                <button
                    onClick={onSubmit}
                    className="btn bg-orange-500 text-white">Submit</button>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-6">
                ...
                <div className="bg-white p-4 rounded-lg shadow-lg">
                    <h3 className="text-gray-600 text-lg font-semibold">Total Delivered</h3>
                    <p className="text-2xl font-bold text-green-600">{data?.totalDelivered}</p>
                </div>

                {/* Total Returned */}
                <div className="bg-white p-4 rounded-lg shadow-lg">
                    <h3 className="text-gray-600 text-lg font-semibold">Total Returned</h3>
                    <p className="text-2xl font-bold text-yellow-600">{data?.totalReturned}</p>
                </div>

                {/* Total Costing */}
                <div className="bg-white p-4 rounded-lg shadow-lg">
                    <h3 className="text-gray-600 text-lg font-semibold">Total Costing</h3>
                    <p className="text-2xl font-bold text-blue-600">৳{data?.totalCosting}</p>
                </div>
                ...
                {/* Total Selling Price */}
                <div className="bg-white p-4 rounded-lg shadow-lg">
                    <h3 className="text-gray-600 text-lg font-semibold">Total Selling Price</h3>
                    <p className="text-2xl font-bold text-purple-600">৳{data?.totalSellingPrice}</p>
                </div>
